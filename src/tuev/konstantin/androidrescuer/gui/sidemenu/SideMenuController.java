package tuev.konstantin.androidrescuer.gui.sidemenu;
...
import tuev.konstantin.androidrescuer.mycomponenets.MapController;
...
public class SideMenuController {
    ...
    public void init() {
        ...
        sideList.getSelectionModel().selectedItemProperty().addListener((o, oldVal, newVal) -> new Thread(()->{
            Platform.runLater(()->{
                if (newVal != null) {
                    try {
        ...
        bindNodeToController(message, PhoneController.class, contentFlow, contentFlowHandler);
